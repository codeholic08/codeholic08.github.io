...
Core portfolio copy lives in `index.html`. The visual palette, typography, spacing, and responsive layouts are controlled by variables and component sections in `styles.css`.
